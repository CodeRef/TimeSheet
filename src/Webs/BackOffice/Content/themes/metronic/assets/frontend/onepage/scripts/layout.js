var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", "../../Content/themes/metronic/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "../../Content/themes/metronic/assets/frontend/onepage/img/logo/" + color + ".png");
        }
