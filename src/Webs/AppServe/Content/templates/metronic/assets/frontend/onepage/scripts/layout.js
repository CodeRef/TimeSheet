var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", "../../Content/templates/metronic/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "../../Content/templates/metronic/assets/frontend/onepage/img/logo/" + color + ".png");
        }
