        ...
        copy: {
            vendor: {
                ...
                },
                {
                    ...
                    "src": "jquery.min.js", "dest": "<%=mvc.tmp%>/vendor"
                },
                {
                    "expand": true,
                    "cwd": "<%=mvc.js%>/vendor/momentjs/min",
                    "src": "moment.min.js", "dest": "<%=mvc.tmp%>/vendor"
                },
                {
                    "expand": true,
                    "cwd": "<%=mvc.js%>/vendor/respond/src",
                    "src": "respond.js", "dest": "<%=mvc.tmp%>/vendor"
                },
                {
                    "expand": true,
                ...
                {
                    "expand": true,
                    "cwd": "<%=mvc.js%>/vendor/angular-local-storage/dist",
            ...
            compile: {
                options: {
                    ...
                    paths: {
                        ...
                        'localStorageService': '../<%=mvc.tmp%>/vendor/angular-local-storage'
                    },
                    shim: {
                        'moment': {
                            exports: 'moment'
